import { r as reactExports, j as jsxRuntimeExports, ac as React, ad as clsx, a as cn } from "./index-XR9C81Ts.js";
...
var FormationType = /* @__PURE__ */ ((FormationType2) => {
  FormationType2["two_candle"] = "two_candle";
  FormationType2["multi_candle"] = "multi_candle";
  FormationType2["three_candle"] = "three_candle";
  FormationType2["single"] = "single";
  return FormationType2;
})(FormationType || {});
var PatternCategory = /* @__PURE__ */ ((PatternCategory2) => {
  PatternCategory2["indecision"] = "indecision";
  PatternCategory2["bearish_reversal"] = "bearish_reversal";
  PatternCategory2["bullish_reversal"] = "bullish_reversal";
  PatternCategory2["bearish_continuation"] = "bearish_continuation";
  PatternCategory2["bullish_continuation"] = "bullish_continuation";
  return PatternCategory2;
})(PatternCategory || {});
var Reliability = /* @__PURE__ */ ((Reliability2) => {
  Reliability2["low"] = "low";
  Reliability2["high"] = "high";
  Reliability2["medium"] = "medium";
  return Reliability2;
})(Reliability || {});
...
function CandleShape({
  ...
  const color2 = candle.bullish ? BULLISH_COLOR : BEARISH_COLOR;
...
function buildCandlesForPattern(patternId, category, formationType) {
  const key = patternId.toLowerCase().replace(/-/g, "_");
  if (PATTERN_CANDLES[key] !== void 0) {
    if (PATTERN_CANDLES[key].length === 0) return "doji";
    return PATTERN_CANDLES[key];
  }
  const isBullish = category === PatternCategory.bullish_reversal || category === PatternCategory.bullish_continuation;
...
function CandlestickDiagram({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      className: "shrink-0",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: `Candlestick diagram for ${patternId}` }),
        [20, 40, 60, 80].map((y) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "line",
          {
            x1: 0,
            y1: y,
        ...
        result === "doji" ? /* @__PURE__ */ jsxRuntimeExports.jsx(DojiShape, { x: 43, y: 45, width: 14 }) : result.map((c, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          CandleShape,
          {
            candle: c,
...
const CATEGORY_STYLES = {
  [PatternCategory.bullish_reversal]: "bg-[oklch(0.92_0.08_150)] text-[oklch(0.35_0.18_150)] border border-[oklch(0.75_0.14_150)]",
  [PatternCategory.bearish_reversal]: "bg-[oklch(0.95_0.06_25)] text-[oklch(0.38_0.22_25)] border border-[oklch(0.78_0.18_25)]",
  [PatternCategory.bullish_continuation]: "bg-[oklch(0.9_0.06_150)] text-[oklch(0.32_0.16_150)] border border-[oklch(0.72_0.12_150)]",
  [PatternCategory.bearish_continuation]: "bg-[oklch(0.95_0.05_25)] text-[oklch(0.4_0.2_25)] border border-[oklch(0.8_0.16_25)]",
  [PatternCategory.indecision]: "bg-muted text-muted-foreground border border-border"
};
const SIZE_STYLES = {
  sm: "text-[10px] px-1.5 py-0.5 font-medium tracking-wide",
  md: "text-xs px-2.5 py-1 font-semibold tracking-wide"
};
function PatternBadge({ category, size = "md" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
...
export {
  ...
  Card as C,
  FormationType as F,
  PatternCategory as P,
  Reliability as R,
  Button as a,
  CardContent as b,
  CandlestickDiagram as c,
  PatternBadge as d,
  FORMATION_LABELS as e,
  RELIABILITY_LABELS as f,
  CATEGORY_LABELS as g,
  CardHeader as h,
  CardTitle as i,
  motion as m
};
